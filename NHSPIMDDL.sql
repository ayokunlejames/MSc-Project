...
CREATE TABLE manufacturer_catalog (
    ...
    last_status_update        DATE,
    manufacturer_gln          NUMBER(13) NOT NULL,
    authorized_rep_id         VARCHAR2(32 BYTE) NOT NULL,
...
ALTER TABLE manufacturer_catalog
    ADD CONSTRAINT manufacturer_catalog_authorized_rep_fk FOREIGN KEY ( authorized_rep_id )
        REFERENCES authorized_rep ( rep_id );

--  ERROR: FK name length exceeds maximum allowed length(30) 
ALTER TABLE manufacturer_catalog
    ADD CONSTRAINT manufacturer_catalog_manufacturer_fk FOREIGN KEY ( manufacturer_gln )
...
ALTER TABLE medical_device
    ADD CONSTRAINT medical_device_gmdn_fk FOREIGN KEY ( gmdn_code )
        REFERENCES gmdn ( gmdn_code );

ALTER TABLE medical_device
    ADD CONSTRAINT medical_device_item_model_fk FOREIGN KEY ( gmn )
        REFERENCES item_model ( gmn );

ALTER TABLE medical_device
    ADD CONSTRAINT medical_device_manufacturer_fk FOREIGN KEY ( manufacturer_gln )
        REFERENCES manufacturer ( manufacturer_gln );
